...
import { TransactionHistory } from 'src/app/module/transactionhistory';
...
export class PaymentgatewayComponent {
    ...
    constructor(private eservice: AdminService, private route: ActivatedRoute,private router:Router,private userService:UserserviceService,private servservice:ServiceService) {
  ...
  console.log(this.plantransaction);
            ...
            this.userService.updateWalletBalance(this.users.emailAddress, this.users).subscribe();
                      this.servservice.transactionrecharge(this.plantransaction).subscribe(() => {
                        ...
                        this.servservice.generateBill(this.plantransaction.phoneNumber).subscribe((response: Map<string, string>) => {
